...
export const Header = ({ scrollY }: HeaderProps) => {
  return (
    <header 
      className="fixed top-0 z-50 w-full border-b border-gray-200/50 bg-white/80 backdrop-blur-sm transition-all duration-300"
      style={{
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4 sm:py-6">
          ...
          <nav className="flex space-x-4 sm:space-x-8">
            <Link href="/" className="text-sm font-medium text-gray-900 transition-colors hover:text-gray-600 sm:text-base">作品</Link>
            <Link href="/about" className="text-sm text-gray-600 transition-colors hover:text-gray-900 sm:text-base">プロフィール</Link>
