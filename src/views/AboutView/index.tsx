        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="space-y-8">
              <div>
                <h2 className="mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-2xl font-playfair font-bold text-transparent">アーティストプロフィール</h2>
                <div className="space-y-4 font-cormorant text-gray-300">
                  <p>
              ...
              <div>
                <h3 className="mb-3 text-lg font-playfair font-semibold text-white">学歴・経歴</h3>
              ...
              <div>
                <h3 className="mb-3 text-lg font-playfair font-semibold text-white">受賞歴</h3>
                <div className="space-y-2 font-inter text-gray-400">
                  <div className="flex">
                    <span className="w-16 text-sm font-medium">2018年</span>
              ...
              <div>
                <h3 className="mb-3 text-lg font-playfair font-semibold text-white">制作技法</h3>
